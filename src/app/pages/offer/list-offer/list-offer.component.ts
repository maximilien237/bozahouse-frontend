...
import {FormBuilder, UntypedFormBuilder, UntypedFormGroup, ValidationErrors, Validators} from "@angular/forms";
...
export class ListOfferComponent implements OnInit {
  ...
  offerFormGroup!: UntypedFormGroup ;
  currentUser!: AppUser;
  ...
  resultDatesCompare : boolean = false;
